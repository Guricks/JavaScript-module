...
for (const user of usersList) {
    ...
    let addressWrapper = document.createElement('ul');

    let addressStreet = document.createElement('li');
    addressStreet.innerText = user.address.street;

    let addressSuite = document.createElement('li');
    ...
    let addressZipcode = document.createElement('li');
    addressZipcode.innerText = user.address.zipcode;


    let geoWrapper = document.createElement('ul');

    let geoLat = document.createElement('li');
    geoLat.innerText = user.address.geo.lat;

    let geoLng = document.createElement('li');
    geoLng.innerText = user.address.geo.lng;
    ...
    addressWrapper.appendChild(addressSuite);
    addressWrapper.appendChild(addressCity);
    addressWrapper.appendChild(addressZipcode);
    geoWrapper.appendChild(geoLat);
    geoWrapper.appendChild(geoLng);

    userElement.appendChild(addressWrapper);
    addressWrapper.appendChild(geoWrapper);

    userElement.appendChild(userPhone);
    userElement.appendChild(userWebsite);

    userCompany.appendChild(companyName);
    userCompany.appendChild(companyCatchPhrase);
    userCompany.appendChild(companyBs);
    userElement.appendChild(userCompany);
